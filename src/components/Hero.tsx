...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-20 flex flex-col md:flex-row items-center gap-12 mt-10 md:mt-0">
        ...
        <div className="flex-1 text-center md:text-left animate-fade-in-up">
          ...
          <h1 className="font-heading font-black text-5xl md:text-6xl lg:text-7xl leading-[1.1] mb-6 tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-[#D9D9D9]">
            {siteConfig.hero.title}
          </h1>
          
          <p className="text-lg md:text-xl text-[#D9D9D9] mb-10 max-w-2xl mx-auto md:mx-0 leading-relaxed font-light">
            {siteConfig.hero.subtitle}
          </p>
          
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <Button href={whatsappUrl} asExternal size="lg" className="w-full sm:w-auto shadow-[0_0_20px_rgba(46,134,222,0.3)]">
              {siteConfig.hero.ctaPrimary}
            </Button>
            <Button href="#servicios" variant="outline" size="lg" className="w-full sm:w-auto backdrop-blur-sm bg-[rgba(13,27,42,0.4)]">
        ...
        <div className="flex-1 w-full max-w-lg hidden md:block animate-fade-in-up delay-200">
