    ...
    <footer className="bg-[#0D1B2A] pt-40 pb-12 border-t border-[#111111]">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              {(siteConfig.instagram as string) && !(siteConfig.instagram as string).includes("[") && (
        ...
        <div className="pt-8 border-t border-[rgba(255,255,255,0.05)] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-xs text-[#D9D9D9]/30">
            <span className="cursor-not-allowed hidden sm:inline-block" title="Página en construcción">Privacidad</span>
            <span className="cursor-not-allowed hidden sm:inline-block" title="Página en construcción">Términos</span>
          </div>
        </div>
      </div>
    </footer>
